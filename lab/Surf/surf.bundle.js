! function (e) {
    function s(s) {
        for (var i, r, n = s[0], c = s[1], h = s[2], l = 0, p = []; l < n.length; l++) r = n[l], a[r] && p.push(a[r][0]), a[r] = 0;
    ...
    function t() {
        for (var e, s = 0; s < o.length; s++) {
            for (var t = o[s], i = !0, n = 1; n < t.length; n++) {
                var c = t[n];
                0 !== a[c] && (i = !1)
            }
            i && (o.splice(s--, 1), e = r(r.s = t[0]))
        }
        return e
    }
    var i = {},
    ...
    r.m = e, r.c = i, r.d = function (e, s, t) {
        ...
        if (r.r(t), Object.defineProperty(t, "default", {
            ...
            for (var i in e) r.d(t, i, function (s) {
                return e[s]
            }.bind(null, i));
        return t
    }, r.n = function (e) {
    ...
    var n = window.webpackJsonp = window.webpackJsonp || [],
        c = n.push.bind(n);
    n.push = s, n = n.slice();
    for (var h = 0; h < n.length; h++) s(n[h]);
    var d = c;
    o.push([475, 1, 0]), t()
}({
    475: function (e, s, t) {
        ...
        const g = {
            ...
            w = {
                ...
                settingsHamburgerMenu_closeButton: Object.assign({}, Object(m.a)(l.b, p.D, p.D), {
                    position: "absolute",
                    top: "0",
                    margin: "6px",
        ...
        class W {
            ...
            static recordUnload() {
                const e = Date.now() - W.sessionStartTime,
                    s = {
        ...
        class F {
            ...
            draw(e, s, t, i) {
                Xe.data.ctx.drawImage(this.image, t * this.spriteWidth, i * this.spriteHeight, this.spriteWidth, this.spriteHeight, Math.floor(e), Math.floor(s), this.spriteWidth, this.spriteHeight)
            }
        }
        ...
        class ae {
            constructor(e, s, t, i, a, o) {
                this.hitbox = new re(this, 0, 0, t, i), this.x = e, this.y = s, this.width = t, this.height = i, this.sprite = a, this.pose = o, this.reset()
            }
            reset() {
                this.creation = Xe.data.game.time.elapsed, this.lifetime = 0, this.fps = 6, this.frame = {
                    current: 1,
            ...
            update() {
                if (this.lifetime += Xe.data.game.time.loop, this.sprite.frames > 1 && this.isAnimated) {
            ...
            move() {
                this.shift(-Xe.data.player.speed.x, -Xe.data.player.speed.y)
            }
            shift(e = 0, s = 0) {
            ...
            changeFrame(e) {
                e || (e = this.frame.current + 1), this.frame.current = e, this.frame.updated = Xe.data.game.time.elapsed
            }
            cycleFrame(e, s, t = this.fps) {
                if (Xe.data.game.time.elapsed >= e.updated + 1 / t) {
                    e.updated = Xe.data.game.time.elapsed;
                    let t = e.current + 1;
            ...
            drawHitbox() {
                ...
                let a = "#000000";
                let o = !1;
                if (Xe.data.session.isHighContrast) switch (this.strokeType) {
                    case "COLLIDE":
                        a = "CanvasText";
                        break;
                    case "GOOD":
                ...
                const r = Xe.data.ctx;
                r.beginPath(), r.lineWidth = "4", r.strokeStyle = "" + a, o ? r.setLineDash([8]) : r.setLineDash([]), r.strokeRect(e + 1, s + 1, t - 2, i - 2)
            }
            drawLayer(e, s, t, i, a) {
        ...
        class ne extends ae {
            constructor(e, s, t) {
                super(e, s, 128, 128, t, 1), this.hitbox = new re(this, 32, 80, 64, 40), this.reset()
            }
            reset() {
                super.reset(), this.state = "CHASE", this.type = "Enemy", this.defineEffect("ENEMY"), this.gotPlayer = !1, this.obstaclesHit = [], this.rippleOffset = void 0, this.angle = {
                    ...
                    current: 1,
                    updated: this.creation
                }, this.speed.raw = Xe.data.player.speed.raw + 1
            }
            update() {
            ...
            cycleEnemyFrame(e, s) {
                if (Xe.data.game.time.elapsed >= this.frame.updated + 1 / this.fps) {
            ...
            isCrashed() {
                return !(this.timer.crash <= 0) && (this.timer.crash -= Xe.data.game.time.loop * Xe.data.game.time.scale, !(this.timer.crash <= 0) || (this.resume(), !1))
            }
            changeState(e) {
            ...
            updateDirection() {
                if (this.angle.distance = Math.hypot(Xe.data.session.xOrigin - this.x, Xe.data.session.yOrigin - this.y), this.timer.direction -= Xe.data.game.time.loop * Xe.data.game.time.scale, this.timer.direction <= 0) {
                    this.timer.direction += Xe.data.randomNumberBetween(25, 100) / 100 * (this.angle.distance / Xe.data.session.yOrigin);
                    const e = Xe.data.session.xOrigin - this.x,
                        s = Xe.data.session.yOrigin - this.y;
                    this.angle.current = 180 * Math.atan2(s, e) / Math.PI, this.angle.radian = this.angle.current * Math.PI / 180
                }
            }
            updateSpeed() {
                const e = this.y >= Xe.data.session.yOrigin;
                this.speed.raw < this.speed.max && !e ? this.speed.raw += this.speed.accel * Xe.data.game.time.scale : e ? this.speed.raw -= this.speed.accel * Xe.data.game.time.scale : this.speed.raw = this.speed.max, this.speed.current = this.speed.raw * Xe.data.game.time.scale
            }
            updatePosition() {
                const e = this.angle.distance / Xe.data.session.yOrigin * 15,
        ...
        class ce extends ae {
            constructor(e, s, t) {
                super(e, s, 64, 64, t), this.hitbox = new re(this, 20, 32, 24, 24), this.reset()
            }
            reset() {
                super.reset(), this.state = "CRASH", this.type = "Surfer", this.defineEffect("SURFER"), this.boardPose = 0, this.hitByPlayer = !1, this.obstaclesHit = [], this.angle = {
                    ...
                    crash: 0,
                    direction: 0
                }, this.surferInstance = Xe.data.randomNumberBetween(1, 9), this.surferInstance <= 6 ? this.boardInstance = Xe.data.randomNumberBetween(1, 6) : this.boardInstance = Xe.data.randomNumberBetween(7, 9), this.resume()
            }
            update() {
            ...
            updateDirection() {
                if (this.timer.direction -= Xe.data.game.time.loop * Xe.data.game.time.scale, this.timer.direction <= 0 && (this.timer.direction += Xe.data.randomNumberBetween(25, 150) / 100, Math.random() > .5)) {
                    const e = "LEFT" === this.state ? "RIGHT" : "LEFT";
                    this.changeState(e)
                }
            }
            updateSpeed() {
                this.speed.raw < this.speed.max ? this.speed.raw += this.speed.accel * Xe.data.game.time.scale : this.speed.raw > this.speed.max ? this.speed.raw -= this.speed.accel * Xe.data.game.time.scale : this.speed.raw = this.speed.max, this.speed.current = this.speed.raw * Xe.data.game.time.scale
            }
            updatePosition() {
        ...
        class he extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, z, t), this.hitbox = new re(this, 6, 16, 52, 32), this.reset()
            }
            reset() {
                super.reset(), this.type = "Docks64", this.defineEffect("HIT"), this.isAnimated = !1, this.rippleOffset = -6, this.dockDecor = void 0, this.dockDecorPos = void 0, this.pose >= 1 && this.pose <= 8 && Math.random() < .75 && (this.dockDecor = Xe.data.randomNumberBetween(1, 12), this.dockDecorPos = Xe.data.randomNumberBetween(-16, -24)), this.pose >= 10 && this.pose <= 12 && (this.rippleOffset = void 0)
            }
            draw() {
        ...
        class de extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, K, t), this.hitbox = new re(this, 12, 36, 40, 20), this.reset()
            }
            reset() {
        ...
        class le extends oe {
            constructor(e, s, t) {
                super(e, s, 32, 32, J, t), this.hitbox = new re(this, 4, 20, 24, 12), this.reset()
            }
            reset() {
        ...
        class pe extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, X, t), this.hitbox = new re(this, 8, 8, 48, 24), this.reset()
            }
            reset() {
        ...
        class ue extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, X, t), this.hitbox = new re(this, -64, -64, 192, 192), this.reset()
            }
            reset() {
        ...
        class me extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, q, t), this.hitbox = new re(this, 4, 8, 56, 48), this.reset()
            }
            reset() {
        ...
        class ge extends oe {
            constructor(e, s, t) {
                super(e, s, 192, 64, Q, t), this.hitbox = new re(this, 8, 8, 176, 48), this.reset()
            }
            reset() {
        ...
        class be extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, X, t), this.hitbox = new re(this, 0, 0, 64, 64), this.reset()
            }
            reset() {
        ...
        class ke extends oe {
            constructor(e, s, t) {
                super(e, s, 128, 128, Z, t), this.hitbox = new re(this, 16, 32, 96, 64), this.reset()
            }
            reset() {
        ...
        class Oe extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, se, t), this.hitbox = new re(this, 0, 0, 64, 64), this.reset()
            }
            reset() {
        ...
        class xe extends oe {
            constructor(e, s, t) {
                super(e, s, 256, 128, te, t), this.hitbox = new re(this, 24, 72, 208, 24), this.reset()
            }
            reset() {
        ...
        class ve extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, K, t), this.hitbox = new re(this, 8, 36, 48, 20), this.reset()
            }
            reset() {
        ...
        class Te extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, X, t), this.hitbox = new re(this, -32, -32, 128, 128), this.reset()
            }
            reset() {
        ...
        class Ce extends oe {
            constructor(e, s, t) {
                super(e, s, 64, 64, K, t), this.hitbox = new re(this, 16, 48, 32, 16), this.reset()
            }
            reset() {
        ...
        class Me extends oe {
            constructor(e, s, t) {
                super(e, s, 224, 64, K, t), this.hitbox = new re(this, 0, 0, 224, 64), this.reset()
            }
            update() {}
            reset() {
        ...
        class Ie extends oe {
            constructor(e, s, t) {
                super(e, s, 756, 512, K, t), this.hitbox = new re(this, 0, 0, 756, 512), this.reset()
            }
            update() {}
            reset() {
        ...
        class Ae extends oe {
            constructor(e, s, t) {
                super(e, s, 1280, 512, ie, t), this.hitbox = new re(this, 0, 180, 1280, 100), this.reset()
            }
            reset() {
        ...
        class De extends oe {
            constructor(e, s, t) {
                super(e, s, 128, 128, Z, t), this.hitbox = new re(this, 0, 0, 128, 256), this.reset()
            }
            reset() {
            ...
            startChestAnimation() {
                this.frame.updated = Xe.data.game.time.elapsed, this.isAnimated = !0
            }
            update() {
        ...
        class Le {
            ...
            createPlayer() {
                const e = Xe.data.session.xOrigin,
                    s = Xe.data.session.yOrigin;
                this.player = this.createObject("Player", e, s), this.player.reset(), this.everything.push(this.player)
            }
            createSurfer() {
                const e = Math.random() * Xe.data.session.width;
                let s = -32;
                const t = Xe.data.randomNumberBetween(1, 13);
                t < Xe.data.player.speed.raw && (s = Xe.data.session.height), this.buildNewObject("Surfer", e, s).speed.max = t
            }
            createEnemy() {
                const e = Math.random() * Xe.data.session.width;
            ...
            buildStartScene() {
                switch (Xe.data.session.settings.mode) {
                    case "CLASSIC":
            ...
            update() {
                switch (this.putToSleep(), this.grid.xGap = this.grid.gap * this.grid.size + this.grid.padding * this.grid.size, this.grid.yGap = this.grid.height * this.grid.size + this.grid.padding * this.grid.size, Xe.data.session.settings.mode) {
                    case "CLASSIC":
            ...
            updateClassicMode() {
                this.spawnClassic.row.next < Xe.data.game.distance.yPx && (this.createClassicClusters(), this.spawnClassic.row.next += this.grid.yGap + this.grid.padding * this.grid.size * 2), !this.player.swimming && this.spawnClassic.enemy.next < Xe.data.game.distance.y && (this.createEnemy(), this.spawnClassic.enemy.next += this.spawnClassic.enemy.inc), this.spawnClassic.surfer.next < Xe.data.game.distance.y ? (this.createSurfer(), this.spawnClassic.surfer.next += this.spawnClassic.surfer.inc) : this.player.swimming && this.spawnClassic.surfer.next - this.spawnClassic.surfer.inc / 2 < Xe.data.game.distance.y && (this.createSurfer(), this.spawnClassic.surfer.next += this.spawnClassic.surfer.inc)
            }
            updateSpeedMode() {
                if (this.spawnSpeed.row.next < Xe.data.game.distance.yPx)
                    ...
                    const e = Xe.data.session.xOrigin - Xe.data.game.distance.xPx,
                        s = Xe.data.session.yOrigin - Xe.data.game.distance.yPx + this.spawnSpeed.row.next + (Xe.data.session.height - Xe.data.session.yOrigin) + this.spawnSpeed.row.inc;
                    this.buildIsland(e, s)
                }
            }
            updateBuoyMode() {
                this.spawnBuoy.row.next < Xe.data.game.distance.yPx && (this.createBuoyPass(), this.createBuoyClusters(), this.spawnBuoy.row.next += this.spawnBuoy.row.inc)
            }
            createClassicStart() {
                const e = Xe.data.session.xOrigin,
                    s = Xe.data.session.yOrigin + 128;
            ...
            createClassicClusters() {
                ...
                for (let a = 0; a < e.length; a++) {
                    let o = Xe.data.randomNumberBetween(-6, 6) * this.grid.size,
                        r = Xe.data.randomNumberBetween(0, 12) * this.grid.size,
                        n = this.cluster.normal;
                    0 === a && (o = 0, r = 0, Xe.data.player.distance.air > 0 ? n = this.cluster.passive : this.spawnClassic.character.next < Xe.data.game.distance.y ? (n = this.cluster.characterScenes, this.spawnClassic.character.next += this.spawnClassic.character.inc) : this.spawnClassic.dog.next < Xe.data.game.distance.y ? (n = this.cluster.dog, this.spawnClassic.dog.next += this.spawnClassic.dog.inc) : this.spawnClassic.powerup.next < Xe.data.game.distance.y ? (n = this.cluster.powerup, this.spawnClassic.powerup.next += this.spawnClassic.powerup.inc) : this.spawnClassic.ramp.next < Xe.data.game.distance.y ? (n = this.cluster.ramp, this.spawnClassic.ramp.next += this.spawnClassic.ramp.inc) : this.spawnClassic.tentacle.next < Xe.data.game.distance.y && (n = this.cluster.tentacle, this.spawnClassic.tentacle.next += this.spawnClassic.tentacle.inc));
                    let c = 0;
                    "LEFT" === Xe.data.player.direction || "DOWN LEFT" === Xe.data.player.direction ? c = -this.grid.xGap / 2 : "RIGHT" !== Xe.data.player.direction && "DOWN RIGHT" !== Xe.data.player.direction || (c = this.grid.xGap / 2);
                    const h = Xe.data.session.xOrigin + e[a] + o + c,
                        d = Xe.data.session.height + 128 + s[a] + r;
                    this.buildCluster(n, h, d), this.buildClassicRandomObstacles(h, d, t, i, 448)
                }
            }
            createFirstSpeedStart() {
                const e = this.cluster.speedActs,
                    s = Xe.data.session.xOrigin - Xe.data.game.distance.xPx,
                    t = Xe.data.session.yOrigin - Xe.data.game.distance.yPx + this.spawnSpeed.row.next,
                    i = this.allSpeedActs[this.currentSpeedAct];
                this.buildCluster(e, s, t, !1, i), this.spawnSpeed.row.next += this.spawnSpeed.row.inc - (Xe.data.session.height - Xe.data.session.yOrigin), this.currentSpeedAct += 1
            }
            createSpeedClusters() {
                const e = this.cluster.speedActs,
                    s = Xe.data.session.xOrigin - Xe.data.game.distance.xPx,
                    t = Xe.data.session.yOrigin - Xe.data.game.distance.yPx + this.spawnSpeed.row.next + (Xe.data.session.height - Xe.data.session.yOrigin),
                    i = this.allSpeedActs[this.currentSpeedAct];
                this.buildCluster(e, s, t, !1, i), this.currentSpeedAct += 1
            }
            createFirstBuoyPass() {
                const e = Xe.data.session.height - 128;
                this.nextBuoyCluster = this.buildCluster(this.cluster.buoyFirst, Xe.data.session.xOrigin, e, !0)
            }
            createBuoyPass() {
                let e, s;
                this.totalBuoyCount += 1;
                const t = Xe.data.session.height + 128 - Xe.data.game.distance.yPx + this.spawnBuoy.row.next;
                this.nextBuoyIsLeft ? (e = this.cluster.buoyLeft, s = Xe.data.session.xOrigin - 320 - Xe.data.game.distance.xPx - 1 * this.grid.size, this.nextBuoyIsLeft = !1) : (e = this.cluster.buoyRight, s = Xe.data.session.xOrigin + 320 - Xe.data.game.distance.xPx + 1 * this.grid.size, this.nextBuoyIsLeft = !0), this.prevBuoyCluster = this.nextBuoyCluster, this.nextBuoyCluster = this.buildCluster(e, s, t, !0)
            }
            confirmBuoyHit(e) {
            ...
            createBuoyClusters() {
                const e = this.cluster.normal,
                    s = Xe.data.session.xOrigin - Xe.data.game.distance.xPx;
                let t = Xe.data.session.height + .6 * this.spawnBuoy.row.inc;
                const i = Xe.data.randomNumberBetween(0, 2) * this.grid.size,
                    a = Xe.data.randomNumberBetween(0, 3) * this.grid.size;
                this.buildCluster(e, s - 560 - i, t), this.buildCluster(e, s + 560 + i, t + a);
                let o = 128;
                this.nextBuoyIsLeft && (o = -128), this.buildCluster(e, s + o, Xe.data.session.height + 128 - Xe.data.game.distance.yPx + this.spawnBuoy.row.next), this.buildCluster(this.cluster.buoyRandom, s, t), t += 5.5 * this.grid.size, this.spawnBuoy.heart.next < Xe.data.game.distance.y ? (this.buildNewObject("Heart64", s, t, 4), this.spawnBuoy.heart.next += this.spawnBuoy.heart.inc) : this.spawnBuoy.powerup.next < Xe.data.game.distance.y ? (this.buildNewObject("Powerup64", s, t, 3), this.spawnBuoy.powerup.next += this.spawnBuoy.powerup.inc) : Math.random() < .1 && this.buildNewObject("Whirlpool128", s, t, 1)
            }
            buildCluster(e, s, t, i = !1, a) {
                ...
                if (a) o = e[a];
                    ...
                    o = e[Xe.data.randomArrayIndex(s)];
                    let t = 0;
                    for (; - 1 !== this.clustersLastSpawned.indexOf(o) && t < 5;) o = e[Xe.data.randomArrayIndex(s)], t++
                }
                ...
                for (const e in o)
                    if (o.hasOwnProperty(e)) {
                        ...
                        for (let t = 0; t < s.length - 1; t++) {
                            const i = s[t],
                                a = r + i[0] * this.grid.size,
                                o = n + i[1] * this.grid.size;
                            let h = i[2];
                            void 0 === h ? h = Xe.data.randomArrayIndex(s[s.length - 1]) : Array.isArray(h) && (h = Xe.data.randomArrayIndex(i[2]));
            ...
            buildClassicRandomObstacles(e, s, t, i, a) {
                ...
                for (let i = 0; i < t; i++) {
                    const t = e + i * a,
                        r = s + .66 * this.grid.yGap;
                    this.buildNewRandomObstacle(t, r, o)
                }
                for (let t = 0; t < i; t++) {
                    const i = e + this.grid.xGap / 2,
                        r = s + t * a / 2;
                    this.buildNewRandomObstacle(i, r, o)
                }
                for (let t = 0; t < i; t++) {
                    const i = e - this.grid.xGap / 2,
                        r = s + a / 2 + t * a / 2;
            ...
            buildNewRandomObstacle(e, s, t) {
                const i = Xe.data.randomNumberBetween(-4 - t, 4 + t) * this.grid.size,
                    a = Xe.data.randomNumberBetween(-2 - t, 2 + t) * this.grid.size;
                let o = "Objects64";
                Math.random() < .5 && (o = Xe.data.randomArrayIndex(this.clusterArray));
                const r = Xe.data.randomArrayIndex(this.cluster.randomObj[o]);
                this.buildNewObject(o, e + i, s + a, r)
            }
            buildIsland(e, s) {
            ...
            buildCove() {
                this.coveBuilt || (this.coveBuilt = !0, this.spawnClassic.row.next += this.grid.yGap + this.grid.padding * this.grid.size * 2, this.obstacles = this.goToSleep(this.obstacles, -64, Xe.data.session.height + 64), this.buildCluster(this.cluster.cove, Xe.data.session.xOrigin - (Xe.data.session.height - Xe.data.session.yOrigin) - 256, Xe.data.session.height))
            }
            ...
            mergeEverything() {
                ...
                if (e.sort((e, s) => e.hitbox.y + e.hitbox.height - (s.hitbox.y + s.hitbox.height)), Xe.data.player.distance.air > 0) {
            ...
            wakeObject(e, s, t, i) {
                ...
                return !!o && ((a = o).shift(s - a.x, t - a.y), a.reset(), a)
            }
            wakeFromSleep(e, s) {
                let t = 0,
                    i = this.sleeping;
            ...
            putToSleep() {
                this.obstacles = this.goToSleep(this.obstacles, -64), this.passives = this.goToSleep(this.passives, -64), this.surfers = this.goToSleep(this.surfers, -64, Xe.data.session.height + 64), this.enemies = this.goToSleep(this.enemies, -128, Xe.data.session.height + 128)
            }
            goToSleep(e, s, t = 1e6) {
                function i(e) {
        ...
        class Re {
            ...
            routeInputType(e) {
                ...
                switch (this.checkDoubleInput(e), e) {
                    ...
                    case "EDGE":
                        ...
                        break;
                    case "RESET":
                        Qe.system.changeGameState("MENU")
                }
            }
            inputUp(e) {
                const s = Xe.data.session.isFlyoutActive;
                "PLAY" !== e || s ? this.inputMenuUp(e) : je.system.changeState("STOP")
            }
            inputDown(e) {
                const s = Xe.data.player.state,
                    t = Xe.data.session.isFlyoutActive;
                "PLAY" !== e || t ? this.inputMenuDown(e) : "AIR" === s.substring(0, 3) ? this.inputTrick(e) : je.system.changeDirection("DOWN")
            }
            inputLeft(e) {
                const s = Xe.data.player.direction,
                    t = Xe.data.session.isFlyoutActive;
            ...
            inputForward(e) {
                ...
                else "PLAY" === e || "PAUSE" === e ? this.inputTogglePlay(e) : "MENU" !== e || s ? "OVER" === e && Qe.system.changeGameState("MENU") : Qe.system.changeGameState("PLAY")
            }
            inputBackward(e) {
                const s = Xe.data.session.isFlyoutActive;
                "PLAY" === e || "PAUSE" === e || s ? this.inputTogglePlay(e) : "OVER" === e && Qe.system.changeGameState("MENU")
            }
            inputSettings(e) {
                Xe.data.session.isFlyoutActive ? Flyout.system.destroyFlyout() : Flyout.system.buildFlyout()
            }
            inputTogglePlay(e) {
                Xe.data.session.isFlyoutActive && Flyout.system.destroyFlyout(), "PLAY" === e ? Qe.system.changeGameState("PAUSE") : "PAUSE" === e && Qe.system.changeGameState("PLAY")
            }
            inputCycleMode(e) {
                if ("MENU" === e) {
                    const e = Xe.data.session.settings.mode;
                    let s;
                    s = "CLASSIC" === e ? "SPEED" : "SPEED" === e ? "BUOY" : "CLASSIC", Xe.data.session.settings.mode = s, Xe.data.saveGameSettings(), ze.system.buildMenu(), ze.system.sendNotification("MODE")
                }
            }
            inputBoost(e) {
            ...
            codeKonami(e) {
                "MENU" === e && (je.system.konamiSprite(), ze.system.sendNotification("KONAMI"))
            }
            codeMicrosoft(e) {
                "MENU" === e && (Xe.data.game.enhancements.codeUsed = !0, Xe.data.game.enhancements.infiniteLives = !0, Xe.data.game.lives.current = 3, ze.system.updateIcons(), ze.system.sendNotification("MICROSOFT", 8e3))
            }
            codeEdge(e) {
                "MENU" === e && (Xe.data.game.enhancements.codeUsed = !0, Xe.data.game.enhancements.infinitePowerups = !0, Xe.data.game.powerups.current = 3, ze.system.updateIcons(), ze.system.sendNotification("EDGE", 8e3))
            }
        }
        class Be {
            constructor() {
            ...
            vibrateController(e, s, t, i) {
                Xe.data.controller.pad.vibrationActuator.playEffect("dual-rumble", {
                    startDelay: e,
                    duration: s,
                    weakMagnitude: t,
                    strongMagnitude: i
            ...
            update() {
                if (-1 === Xe.data.controller.index && this.controllerList.length > 0) {
            ...
            checkVibrations() {
                const e = this.vibrateProps,
                    s = e.TIMER / e.BASE;
                this.vibrateController(e.DELAY, e.TIMER, s * e.WEAK, s * e.STRONG), e.TIMER -= 1e3 * Xe.data.game.time.loop, e.TIMER <= 0 && this.setVibration()
            }
            setController(e, s) {
                const t = Xe.data.controller;
                t.index = e, t.pad = s;
                let i = "xbox";
                t.pad.id.toLowerCase().includes("045e") || t.pad.id.toLowerCase().includes("xbox") ? i = "xbox" : (t.pad.id.toLowerCase().includes("054c") || t.pad.id.toLowerCase().includes("playstation")) && (i = "ps"), this.controllerType = i, Xe.data.changeInputMethod(i)
            }
            checkJoysticks(e) {
                ...
                let o = void 0;
                if (s || t || a || i ? (Xe.data.changeInputMethod(this.controllerType), !a || s || t ? !i || s || t ? !t || a || i ? !s || a || i ? s && a ? o = "RIGHT" : s && i ? o = "DOWN RIGHT" : t && a ? o = "LEFT" : t && i && (o = "DOWN LEFT") : o = "RIGHT" : o = "LEFT" : o = "DOWN" : o = "UP") : this.lastJoystick = void 0, this.lastJoystick !== o) return this.lastJoystick = o, void 0 !== o && Re.system.routeInputType(o), o
            }
            checkButtons(e) {
                function s(e) {
                    return "object" == typeof e ? e.pressed : 1 == e
                }
                if (s(e.buttons[4]) && s(e.buttons[5])) return Re.system.routeInputType("RESET"), this.pressed[4] = !0, void(this.pressed[5] = !0);
                let t = void 0;
                for (let i = 0; i < e.buttons.length; i++)
                    if (s(e.buttons[i])) {
                        ...
                        this.pressed[i] = !0, Xe.data.changeInputMethod(this.controllerType), Re.system.routeInputType(t)
        ...
        class je extends ae {
            constructor(e, s, t) {
                ...
                je.system = this, this.hitbox = new re(this, 20, 32, 24, 24), this.reset()
            }
            reset() {
            ...
            move() {}
            update() {
                super.update(), this.checkBoundaries(), this.cycleFrame(this.surfboardFrame, this.spriteImage.surfboard), this.updateState(), "STOP" !== Xe.data.player.state && "CRASH" !== Xe.data.player.state && this.updateSpeed()
            }
            checkBoundaries() {
                const e = Xe.data.game.distance.xPx,
                    s = Xe.data.game.distance.yPx;
                switch (Xe.data.session.settings.mode) {
                    case "CLASSIC":
            ...
            changeCharacter(e, s = !1) {
                ...
                const t = Xe.data.session.settings.character;
                let i = t;
                if (s) i = e;
                else {
                ...
                this.frame.current = i, this.frame.updated = Xe.data.game.time.elapsed, Xe.data.session.settings.character = i, Xe.data.saveGameSettings(), Be.system.setVibration("SMALL")
            }
            changeState(e) {
                const s = Xe.data.player;
                if (!(s.distance.air > 0 && "AIR" !== e.substring(0, 3) || "BOOST" === e && Xe.data.game.powerups.current <= 0 || s.timer.crash > 0)) {
                    switch (e) {
                        case "DEFAULT":
                            s.speed.max = s.speed.base, Be.system.setVibration("TINY");
                            break;
                        case "STOP":
                            s.speed.current = 0, s.speed.raw = 0, s.speed.max = 0, this.changeDirection("UP"), this.changePose(1), Be.system.setVibration("TINY");
                            break;
                        case "CRASH":
                        ...
                        case "AIR3":
                        case "AIR4":
                            s.speed.max = s.speed.base + s.speed.airAdd, this.changePose(9 + Xe.data.player.trick);
                            break;
                        case "BOOST":
                            this.boost()
                    }
                    Xe.data.player.state = e
                }
            }
            changeDirection(e) {
                const s = Xe.data.player;
            ...
            updateState() {
                const e = Xe.data.player.timer,
                    s = Xe.data.player.distance;
                s.air > 0 && (s.air -= Xe.data.player.speed.current, s.air <= 0) ? this.endAir() : s.boost > 0 && (s.boost -= Xe.data.player.speed.current, s.boost <= 0) ? this.endBoost() : s.bounce > 0 && (s.bounce -= Xe.data.player.speed.current, s.bounce <= 0) ? this.endBounce() : s.immunity > 0 && (s.immunity -= Xe.data.player.speed.current, s.immunity <= 0) ? this.endImmune() : (e.crash > 0 && (e.crash -= Xe.data.game.time.loop * Xe.data.game.time.scale, e.crash <= 0 && this.endCrash()), this.swimming && ("CRASH" === Xe.data.player.state ? (this.frame.current < 5 && this.changeFrame(5), this.cycleSwimFrame(5, 6)) : this.cycleSwimFrame(1, 4)))
            }
            updateSwim() {
                const e = Xe.data.player.timer;
                e.swim > 0 && (e.swim -= Xe.data.game.time.loop * Xe.data.game.time.scale, e.swim <= 0 && this.swim())
            }
            cycleSwimFrame(e, s) {
                if (Xe.data.game.time.elapsed >= this.frame.updated + 1 / this.fps) {
                    let t = this.frame.current + 1;
            ...
            cycleDogWinFrame(e, s) {
                if (Xe.data.game.time.elapsed >= this.dogEndPose.updated + .25) {
                    let t = this.dogEndPose.current + 1;
                    t > s && (t = e), this.dogEndPose.current = t, this.dogEndPose.updated = Xe.data.game.time.elapsed
                }
            }
            updateSpeed() {
                const e = Xe.data.player.speed;
                let s = 1;
                Xe.data.player.distance.air > 0 ? s = 8 : Xe.data.player.distance.boost > 0 && (s = 8), e.raw < e.initial ? e.raw = e.initial : e.raw < e.max ? e.raw += e.accel * s * Xe.data.game.time.scale : e.raw > e.max ? e.raw -= e.accel * s * Xe.data.game.time.scale : e.raw = e.max, e.current = e.raw * Xe.data.game.time.scale
            }
            changePose(e) {
            ...
            slow() {
                Xe.data.player.speed.raw = .8 * Xe.data.player.speed.raw, Be.system.setVibration("SLOW")
            }
            superslow() {
                Xe.data.player.speed.raw = .6 * Xe.data.player.speed.raw, Be.system.setVibration("SLOW")
            }
            crash() {
                this.changeState("CRASH"), Xe.data.player.timer.crash = 1, Xe.data.game.enhancements.collectedDog ? (Xe.data.game.enhancements.collectedDog = !1, Xe.data.game.shields.current = 0, ze.system.announceMessage("lostShield")) : Xe.data.game.enhancements.infiniteLives ? ze.system.announceMessage("playerCrash") : (Xe.data.game.lives.current -= 1, ze.system.announceMessage("playerLifeUsed")), ze.system.refreshInterface(), Xe.data.game.lives.current <= 0 ? this.lose() : Be.system.setVibration("CRASH")
            }
            endCrash() {
                this.changeState("STOP"), Xe.data.player.timer.crash = 0, this.immune()
            }
            air(e = 1600) {
                this.changeDirection("DOWN"), Xe.data.player.distance.air = e, this.shadowOffset = 0, this.newTrick(), Be.system.setVibration("RAMP")
            }
            newTrick() {
                Xe.data.player.trick = Xe.data.player.trick % 4 + 1, this.changeState("AIR" + Xe.data.player.trick), Be.system.setVibration("SMALL")
            }
            endAir() {
                this.changeState("DEFAULT"), this.changeDirection("DOWN"), Xe.data.player.trick = 0, Xe.data.player.distance.air = 0, Be.system.setVibration("SLOW"), this.immune()
            }
            boost() {
                Xe.data.game.enhancements.infinitePowerups ? ze.system.announceMessage("playerBoost") : (Xe.data.game.powerups.current -= 1, ze.system.announceMessage("playerBoostUsed")), Xe.data.player.distance.boost = 2400, Xe.data.player.speed.max = Xe.data.player.speed.base + Xe.data.player.speed.boostAdd, ze.system.refreshInterface(), Be.system.setVibration("BOOST")
            }
            endBoost() {
                this.changeState("DEFAULT"), Xe.data.player.distance.boost = 0
            }
            powerup() {
                Xe.data.game.powerups.current >= Xe.data.game.powerups.max || (Xe.data.game.powerups.current += 1, ze.system.refreshInterface(), Be.system.setVibration("PICKUP"), ze.system.announceMessage("collectedBoost"))
            }
            heart() {
                Xe.data.game.lives.current >= Xe.data.game.lives.max || (Xe.data.game.lives.current += 1, ze.system.refreshInterface(), Be.system.setVibration("PICKUP"), ze.system.announceMessage("collectedLife"))
            }
            coin() {
                Xe.data.game.coins += 1, Be.system.setVibration("PICKUP"), ze.system.announceMessage("collectedCoin")
            }
            spin() {
                Xe.data.player.speed.raw = .8 * Xe.data.player.speed.raw;
                const e = Xe.data.player.direction;
                let s = "DOWN";
                const t = ["LEFT", "DOWN LEFT", "RIGHT", "DOWN RIGHT"];
                switch (e) {
                    case "DOWN":
                        s = t[Xe.data.randomNumberBetween(0, 3)];
                        break;
                    case "DOWN RIGHT":
                    case "RIGHT":
                        s = t[Xe.data.randomNumberBetween(0, 1)];
                        break;
                    case "DOWN LEFT":
                    case "LEFT":
                        s = t[Xe.data.randomNumberBetween(2, 3)]
                }
                this.changeDirection(s), ze.system.announceMessage("playerSpun", e.toLowerCase()), Be.system.setVibration("SLOW")
            }
            bounce() {
                this.spin(), Xe.data.player.distance.bounce = 32
            }
            endBounce() {
                Xe.data.player.distance.bounce = 0
            }
            immune() {
                Xe.data.player.distance.immunity = 96
            }
            endImmune() {
                Xe.data.player.distance.immunity = 0
            }
            rescueDog() {
                Xe.data.game.enhancements.collectedDog = !0, "CLASSIC" === Xe.data.session.settings.mode && (Xe.data.game.shields.current = Xe.data.game.shields.max, ze.system.refreshInterface()), Be.system.setVibration("PICKUP")
            }
            dogShield() {
                Xe.data.game.shields.current -= 1, ze.system.refreshInterface(), Be.system.setVibration("SMALL"), ze.system.announceMessageF("playerShieldUsed")
            }
            grabbedByEnemy() {
                Xe.data.game.lives.current = 0, ze.system.refreshInterface(), this.lose(!0)
            }
            arriveAtIsland() {
                Xe.data.game.isAtIsland = !0, Qe.system.changeGameState("OVER");
                const e = Xe.data.player.speed;
                e.current = 0, e.raw = 0, e.max = 0, this.changePose(9), Be.system.setVibration("BIG")
            }
            triggeredBuoy(e) {
                e - 1 === this.lastBuoyId && (Xe.data.game.buoys += 1, ze.system.announceMessage("triggeredBuoy")), this.lastBuoyId = e, Be.system.setVibration("SMALL")
            }
            missedBuoy(e) {
                Xe.data.game.buoys = 0, this.lastBuoyId = e, Be.system.setVibration("SLOW"), ze.system.announceMessage("missedBuoy")
            }
            konamiSprite() {
                this.konamiActive = !0, this.changeFrame(8)
            }
            startSwimTimer() {
                Xe.data.player.timer.swim = 5
            }
            swim() {
                this.swimming = !0, this.width = 128, this.height = 128, this.hitbox = new re(this, 32, 80, 64, 40), this.sprite = this.spriteImage.swimming, this.pose = 1, this.frame.current = 1, Xe.data.player.timer.swim = 0, Xe.data.player.speed.base = Xe.data.player.speed.base + 3, Xe.data.player.speed.max = Xe.data.player.speed.base, Xe.data.game.enhancements.codeUsed = !0, ze.system.sendNotification("EVENT", 8e3), Be.system.setVibration("BIG")
            }
            resetSwim() {
                this.swimming = !1, this.width = 64, this.height = 64, this.hitbox = new re(this, 20, 32, 24, 24), this.sprite = this.spriteImage.characters, this.changeCharacter(Xe.data.session.settings.character, !0)
            }
            lose(e = !1) {
                Qe.system.changeGameState("OVER");
                const s = Xe.data.player.speed;
                s.current = 0, s.raw = 0, s.max = 0, e ? this.changePose(8) : this.changeState("CRASH"), Be.system.setVibration("BIG")
            }
            enablePlayer() {
                this.changeState("DEFAULT"), this.changeDirection("DOWN"), Be.system.setVibration("BIG"), this.frame.updated = Xe.data.game.time.elapsed, this.surfboardFrame.updated = Xe.data.game.time.elapsed
            }
            drawShadow() {
                const e = Xe.data.ctx;
                Xe.data.player.distance.air <= 256 ? this.shadowOffset = Xe.data.player.distance.air / 4 : this.shadowOffset < 64 ? this.shadowOffset += 3 * Xe.data.game.time.scale : this.shadowOffset = 64, e.beginPath(), e.arc(this.x, this.y + 16 + this.shadowOffset, 20 - this.shadowOffset / 12, 0, 2 * Math.PI), e.fillStyle = "rgba(0,0,0," + (.6 - this.shadowOffset / 200) + ")", e.fill()
            }
            renderCharacterSelection() {
                if (this.cycleFrame(this.surfboardFrame, this.spriteImage.surfboard), Xe.data.game.time.elapsed >= this.frame.updated + 1 / this.fps) {
                    this.frame.updated = Xe.data.game.time.elapsed;
                ...
                if (this.konamiActive) super.drawLayer(this.spriteImage.surfboard, 0, 0, this.pose, this.surfboardFrame.current), this.sprite.draw(this.x + (0 - this.width / 2), this.y - this.height / 2, this.pose - 1, 7);
                    ...
                    for (let e = 1; e <= 7; e++) {
                        const s = 116 * (e - Xe.data.session.settings.character);
                        let t = 4;
                        e === Xe.data.session.settings.character && (t = this.pose), super.drawLayer(this.spriteImage.surfboard, s, 0, t, this.surfboardFrame.current), this.sprite.draw(this.x + (s - this.width / 2), this.y - this.height / 2, t - 1, e - 1)
                    }
            }
            draw() {
                if (this.swimming) super.draw();
                else {
                    if (Xe.data.game.shields.current > 0 && "OVER" !== Xe.data.session.state && super.drawLayer(this.spriteImage.shield, 0, 0, 5 - Xe.data.game.shields.current, this.surfboardFrame.current), Xe.data.player.distance.air > 0 && this.drawShadow(), Xe.data.player.distance.immunity > 0 && (Xe.data.ctx.save(), Math.floor(4 * Xe.data.game.time.elapsed) % 2 == 0 ? Xe.data.ctx.globalAlpha = .3 : Xe.data.ctx.globalAlpha = .7), super.drawLayer(this.spriteImage.surfboard, 0, 0, this.pose, this.surfboardFrame.current), super.draw(), Xe.data.game.enhancements.collectedDog) {
                        let e = this.pose;
                        Xe.data.game.isAtIsland && (this.cycleDogWinFrame(7, 9), e = this.dogEndPose.current), super.drawLayer(this.spriteImage.dog, 0, 0, e, 9)
                    }
                    Xe.data.player.distance.immunity > 0 && Xe.data.ctx.restore()
                }
            }
        }
        class Ne {
        ...
        const We = 1,
            ...
            Fe = {
                ...
                gameSpeed: G.c.getBoolean("reducedSpeedActive") ? He : We,
                mode: function (e) {
                    switch (e) {
                        case "SPEED":
                            return b.Speed;
        ...
        const Ye = Object(Ge.createStore)(function (e = Fe, s) {
            switch (s.type) {
                case _e.UPDATE_STATS:
        ...
        class ze {
            constructor() {
                if (ze.system) return ze.system;
                ze.system = this, this.string = new Ne, this.reset(), Ye.subscribe(this.displayBestCounter.bind(this))
            }
            reset() {
            ...
            buildMenu() {
                ...
                r.innerHTML = this.string.icon.arrowLeft, r.tabIndex = -1, this.createNew("div", a, "selection-box");
                const n = this.createNew("button", a);
                n.innerHTML = this.string.icon.arrowRight, n.tabIndex = -1, r.addEventListener("click", function () {
            ...
            buildPauseInterface() {
                ...
                const e = G.c.getString("pauseTitle"),
                    s = G.c.getStringF("pauseInfo", this.string.buttons[Xe.data.session.inputType].action);
                this.buildTitleInfo(e, s), this.refreshInterface(), $("game-tint").classList.add("visible")
            }
            buildOverInterface() {
                const e = G.c.getString("overTitle"),
                    s = G.c.getStringF("overInfo", this.string.buttons[Xe.data.session.inputType].action);
            ...
            sendNotification(e, s = 5e3) {
                const t = this,
                    i = Xe.data.session.settings.mode;
                this.clearNotification();
                ...
                switch (e) {
                    ...
                    case "MODE":
                        ...
                        break;
                    case "SCORE":
                        let s = Xe.data.session.bestScore[i.toLowerCase()];
                        "SPEED" === i && (s = Xe.data.formatTime(s)), o = G.c.getStringF("newBestScore", G.c.getString(i.toLowerCase() + "Descriptor"), s, G.c.getString(i.toLowerCase() + "Unit"))
                }
            ...
            updateIcons() {
                if (this.lives.innerHTML = "", this.power.innerHTML = "", Xe.data.game.enhancements.infiniteLives && Xe.data.game.shields.current <= 0) this.createNew("div", this.lives, void 0, "icon life-full"), this.createNew("div", this.lives, void 0, "icon infinite");
                else
                    for (let e = 1; e <= Xe.data.game.lives.max; e++) {
                        let s = "life-empty";
                        e <= Xe.data.game.shields.current ? s = "shield" : e <= Xe.data.game.lives.current && (s = "life-full"), this.createNew("div", this.lives, void 0, "icon " + s)
                    }
                if (Xe.data.game.enhancements.infinitePowerups) this.createNew("div", this.power, void 0, "icon powerup-full"), this.createNew("div", this.power, void 0, "icon infinite");
                else
                    for (let e = 1; e <= Xe.data.game.powerups.max; e++) {
                        let s = "powerup-empty";
                        e <= Xe.data.game.powerups.current && (s = "powerup-full"), this.createNew("div", this.power, void 0, "icon " + s)
                    }
            }
            displayBestCounter() {
                const e = Xe.data.session.settings.mode;
                let s = Xe.data.session.bestScore[e.toLowerCase()];
                "SPEED" === e ? s = Xe.data.formatTime(s) : s < 0 && (s = 0), this.counter.innerHTML = G.c.getStringF("bestScoreTopDisplay", this.string.icon.king, s, G.c.getString(e.toLowerCase() + "Unit"))
            }
            updateCounter() {
                let e;
                const s = Xe.data.session.settings.mode;
                switch (s) {
                    case "CLASSIC":
                        e = Math.floor(Xe.data.game.distance.y);
                        break;
                    case "SPEED":
                        e = Xe.data.formatTime(Xe.data.game.time.elapsed - 2 * Xe.data.game.coins);
                        break;
                    case "BUOY":
                        e = Xe.data.game.buoys + " "
                }
        ...
        class $e {
            constructor() {
                if ($e.offline) return $e.offline;
                $e.offline = this, this.loadData(), Ye.subscribe(this.loadData.bind(this))
            }
            loadData() {
                const e = Ye.getState();
                this.localData = {
            ...
            saveData(e) {
                Ye.dispatch(Ue(e)), W.saveBuoyHighScore(e.buoy_bestScore), W.saveClassicHighScore(e.classic_bestScore), W.saveSpeedHighScore(e.speed_bestScore), W.saveGameMode(e.mode), W.saveHighVisibilityMode(e.highVisibilityMode), W.saveReducedSpeedMode(e.gameSpeed < 1), W.saveDefaultSurfer(e.currentCharacter)
            }
            resetData() {
                Ye.dispatch(Ve()), W.resetAllStats()
            }
            storeClassicStats() {
                const e = Math.floor(Xe.data.game.distance.y);
                !Xe.data.game.enhancements.codeUsed && e > this.localData.classic.bestScore && (Xe.data.session.bestScore.classic = e, ze.system.sendNotification("SCORE"), this.saveData(Object.assign({}, Ye.getState(), {
                    classic_bestScore: e
                })))
            }
            storeSpeedStats() {
                const e = this.localData.speed,
                    s = Xe.data.game.time.elapsed - 2 * Xe.data.game.coins;
                !Xe.data.game.enhancements.codeUsed && (s < e.bestScore || -1 === e.bestScore) && Xe.data.game.isAtIsland && (Xe.data.session.bestScore.speed = s, ze.system.sendNotification("SCORE"), this.saveData(Object.assign({}, Ye.getState(), {
                    speed_bestScore: s
                })))
            }
            storeBuoyStats() {
                const e = this.localData.buoy,
                    s = Xe.data.game.buoys;
                !Xe.data.game.enhancements.codeUsed && s >= e.bestScore && ze.system.sendNotification("SCORE")
            }
            storeBuoyStreak() {
                const e = Xe.data.game.buoys,
                    s = this.localData.buoy;
                !Xe.data.game.enhancements.codeUsed && e > s.bestScore && (s.bestScore = e, Xe.data.session.bestScore.buoy = e, this.saveData(Object.assign({}, Ye.getState(), {
                    buoy_bestScore: e
                })))
            }
        }
        ...
        class Xe {
            constructor(e) {
                if (this.canvas = null, this.ctx = null, this.session = void 0, this.controller = void 0, this.player = void 0, this.game = void 0, Xe.data) return Xe.data;
                Xe.data = this, this.canvas = e, this.ctx = this.canvas.getContext("2d"), this.ctx.imageSmoothingEnabled = !1, this.defineSessionSettings(), this.resetCurrentPlayerData(), this.resetCurrentGameData(), Ye.subscribe(this.loadGameSettings.bind(this))
            }
            ...
            changeInputMethod(e) {
                ...
                if (this.session.inputLastChange = s, !(this.session.inputType === e || t < 300)) switch (this.session.inputType = e, this.session.state) {
                    case "MENU":
                        ...
                        break;
                    case "PAUSE":
                        ze.system.buildPauseInterface();
                        break;
                    case "OVER":
                        ze.system.buildOverInterface()
                }
            }
            defineCanvas() {
            ...
            checkHighContrast() {
                window.matchMedia("(forced-colors:active)").matches ? Xe.data.session.isHighContrast = !0 : Xe.data.session.isHighContrast = !1
            }
            definePlayerOrigin() {
        ...
        class qe {
            ...
            filterVisible(e) {
                return e.filter(e => (function (e) {
                    return e.y > -64 && e.y < Xe.data.session.height + 64 && e.x > -64 && e.x < Xe.data.session.width + 64 || "BUOYTRIGGER" === e.effect
                })(e))
            }
            checkCollisions() {
                const e = Xe.data.player.distance.air > 0,
                    s = this.evalSurfers.concat(this.evalEnemies);
                for (let t = 0; t < this.evalImpacts.length; t++) {
                    const i = this.evalImpacts[t],
                        a = 64;
                    if (this.collision(this.evalPlayer, i) && !i.hitByPlayer && !e && i.y + a > Xe.data.session.yOrigin) {
                        ...
                        switch (i.effect) {
                            case "HIT":
                                if (Xe.data.player.distance.immunity > 0) continue;
                                Xe.data.game.enhancements.collectedDog && Le.system.buildNewObject("DogCrash64", this.evalPlayer.x + 24, this.evalPlayer.y + 48, 8), this.evalPlayer.crash();
                                continue;
                            case "SLOW":
                            ...
                            case "COIN":
                                ...
                                continue;
                            case "RAMP":
                                Xe.data.player.distance.boost > 0 && "SPEED" !== Xe.data.session.settings.mode ? this.evalPlayer.air(2048) : "SPEED" === Xe.data.session.settings.mode ? this.evalPlayer.air(512) : this.evalPlayer.air(1024);
                                continue;
                            case "DOG":
                            ...
                            case "SWIMTRIGGER":
                                ...
                                continue;
                            case "BUOYTRIGGER":
                                this.evalPlayer.triggeredBuoy(i.buoyId), $e.offline.storeBuoyStreak(), Le.system.confirmBuoyHit(i.buoyId);
                                continue
                        }
                    } else this.collision(this.evalPlayer, i) && "SWIMTRIGGER" === i.effect && i.hitByPlayer ? this.evalPlayer.updateSwim() : "BUOYTRIGGER" === i.effect && !i.hitByPlayer && i.y < this.evalPlayer.y ? ($e.offline.storeBuoyStats(), this.evalPlayer.missedBuoy(i.buoyId), Le.system.denyBuoyHit(i.buoyId), i.hitByPlayer = !0) : "AMBIENT" === i.effect && i.y + a < this.evalPlayer.y ? i.isAnimated = !0 : "TENTACLE" === i.effect && i.hitByPlayer && !this.evalPlayer.swimming && i.y + 4 * a < this.evalPlayer.y && (Le.system.buildNewObject("Enemy", i.x, i.y), i.sleep = !0);
                ...
                for (let e = 0; e < this.evalEnemies.length; e++) {
                    ...
                    this.collision(s, this.evalPlayer) && !s.gotPlayer && 0 === s.timer.crash && (Xe.data.game.enhancements.collectedDog ? (s.crash(), this.evalPlayer.dogShield()) : (s.grab(), this.evalPlayer.grabbedByEnemy()));
                ...
                for (let s = 0; s < this.evalSurfers.length; s++) {
                    ...
                    this.collision(t, this.evalPlayer) && 0 === Xe.data.player.timer.crash && 0 === t.timer.crash && !e && (Xe.data.game.enhancements.collectedDog ? (t.crash(), this.evalPlayer.dogShield()) : "BOOST" === Xe.data.player.state || this.evalPlayer.swimming ? t.crash() : this.evalPlayer.crash())
                }
            }
        ...
        class Qe {
            constructor(e) {
                if (Qe.system) return Qe.system;
                Qe.system = this, this.statistics = new $e, this.core = new Xe(e), this.router = new Re, this.controller = new Be, this.spawn = new Le, this.collisions = new qe, this.interface = new ze, this.water = $("game-water"), this.xWater = 0, this.yWater = 0, this.reflowCanvas(), this.changeGameState("MENU")
            }
            changeGameState(e) {
                switch (e) {
                    case "MENU":
                        ...
                        break;
                    case "PLAY":
                        if ("PAUSE" === Xe.data.session.state) {
                            this.initializeResume();
                            break
                        }
                        if ("MENU" === Xe.data.session.state) {
                ...
                var s;
                Xe.data.checkHighContrast(), Xe.data.session.state = e, Ye.dispatch((s = e, {
                    type: _e.UPDATE_GAME_STATE,
                    gameState: s
                }))
            }
            gameLoop(e) {
                if (Be.system.update(), "PAUSE" !== Xe.data.session.state && !Xe.data.session.isFlyoutActive) switch (Xe.data.update(e), Xe.data.session.state) {
                    case "MENU":
                        this.updateMenu();
                        break;
                    case "PLAY":
            ...
            initializeMenu() {
                Xe.data.setupNewGame(), Le.system.reset(), ze.system.reset(), ze.system.buildMenu(), ze.system.sendNotification("MODE"), Le.system.createPlayer()
            }
            initializeStart() {
                Xe.data.game.time.elapsed = 0, Le.system.player.enablePlayer(), ze.system.buildGameInterface(), Le.system.buildStartScene()
            }
            initializePause() {
                ze.system.buildPauseInterface()
            }
            initializeResume() {
                ze.system.buildGameInterface()
            }
            initializeOver() {
                switch (Xe.data.session.settings.mode) {
                    case "CLASSIC":
                        $e.offline.storeClassicStats();
                        break;
                    case "SPEED":
                        Le.system.chest && Le.system.chest.startChestAnimation(), $e.offline.storeSpeedStats();
                        break;
                    case "BUOY":
                        $e.offline.storeBuoyStats()
                }
                ze.system.buildOverInterface()
            }
            updateMenu() {
                Xe.data.clearCanvas(), Le.system.player.renderCharacterSelection()
            }
            updatePlay() {
                qe.system.update(), Le.system.update(), Le.system.everything.forEach(e => {
                    e.update(), e.move()
                }), ze.system.update(), this.updateWater(), this.redrawAll()
            }
            updateOver() {
                Le.system.enemies.forEach(e => {
                    e.updateEnemyFrames()
                }), "SPEED" === Xe.data.session.settings.mode && Le.system.chest && Le.system.chest.update(), this.redrawAll()
            }
            redrawAll() {
                Xe.data.clearCanvas();
                const e = Le.system.everything.filter(e => (function (e) {
                    return e.hitbox.x + e.hitbox.width > -32 && e.hitbox.x < Xe.data.session.width + 32 && e.hitbox.y < Xe.data.session.height + 64 || "ISLAND" === e.effect
                })(e));
                Xe.data.session.settings.highVisibility ? e.forEach(e => {
                    e.draw(), e.drawHitbox()
                }) : e.forEach(e => {
                    e.draw()
                }), "CLASSIC" === Xe.data.session.settings.mode || Xe.data.game.isAtIsland || this.drawBoundaries()
            }
            drawBoundaries() {
                const e = Xe.data.session.width,
                    s = Xe.data.session.height,
                    t = Xe.data.session.xOrigin - Xe.data.game.distance.xPx,
                    i = Xe.data.ctx,
                    a = "BUOY" === Xe.data.session.settings.mode ? 960 : 576;
                i.beginPath(), i.rect(0, 0, t - a, s), i.rect(t + a, 0, e, s), i.fillStyle = "rgba(255,255,255,0.2)", i.fill()
            }
            reflowCanvas() {
                const e = Xe.data.session.xOrigin,
                    s = Xe.data.session.yOrigin;
                Xe.data.defineCanvas(), Xe.data.definePlayerOrigin();
                const t = Xe.data.session.xOrigin - e,
                    i = Xe.data.session.yOrigin - s;
                switch (Le.system.everything.forEach(e => {
                    e.shift(t, i)
                }), Xe.data.checkHighContrast(), this.updateWater(t, i), Xe.data.session.state) {
                    case "MENU":
            ...
            updateWater(e = 0, s = 0) {
                this.xWater = (this.xWater + (Xe.data.player.speed.x - e)) % 256, this.yWater = (this.yWater + 1.025 * (Xe.data.player.speed.y - s)) % 256, this.water.style.backgroundPosition = Math.floor(-this.xWater) + "px " + Math.floor(-this.yWater) + "px"
            }
        }
        Qe.system = null;
        var Ze = t(86),
            es = t(33),
            ss = t(15);
        const ts = Object.assign({}, ss.a, {
            baseModal_content: Object.assign({}, ss.a.baseModal_content, {
                color: d.c
            }),
            singleActionModal: {},
            singleActionModal_primaryButton: Object.assign({}, Object(Ze.c)(), Object(es.d)("t7"), {
                height: "32px",
        ...
        var is = t(689),
            as = t(17);
        var os = t(27);
        const rs = Object(os.c)(Object(c.a)(ts)(class extends D.a {
            constructor() {
            ...
            render() {
                ...
                return a.createElement(as.a, Object.assign({}, this.unhandledProps(), {
                ...
                }), e, Object(as.c)(a.createElement(is.a, {
        ...
        const bs = {
                ...
                howToPlayModal_listItem: Object.assign({}, Object(es.d)("t7"), {
                    display: "flex",
                    alignItems: "center",
                    marginBottom: "0.25em"
                }),
            ...
            fs = Object(c.a)(bs)(class extends D.a {
                constructor() {
                    super(...arguments), this.handledProps = {
                        ...
                        if (e.keyCode === hs.a.arrowLeft || e.keyCode === hs.a.arrowUp) switch (this.state.selectedInput) {
                            case "keyboard":
                                return;
                            case "mouse":
                                s = "keyboard";
                            ...
                            if (e.keyCode !== hs.a.arrowRight && e.keyCode !== hs.a.arrowDown) return;
                ...
                render() {
                    return a.createElement(rs, Object.assign({}, this.unhandledProps(), {
                        onKeyDown: ys,
                ...
                getInputDescription(e) {
                    ...
                    switch (e) {
                        case "touch":
                            o = "howToPlayTouchMovement", r = "howToPlayTouchBoost", n = "howToPlayTouchRefresh";
                            break;
                        case "mouse":
                            o = "howToPlayMouseMovement", r = "howToPlayMouseBoost", n = "howToPlayMouseRefresh";
                            break;
                        case "controller":
                            o = "howToPlayControllerMovement", r = "howToPlayControllerBoost", n = "howToPlayControllerRefresh";
                            break;
                        default:
                        case "keyboard":
                            o = "howToPlayKeyboardMovement", r = "howToPlayKeyboardBoost", n = "howToPlayKeyboardRefresh"
                    }
                    return a.createElement("ul", {
                        ...
                        "aria-hidden": !0,
                        className: t
                    }, Object(ds.a)(s)), G.c.getString(o)), a.createElement("li", {
                        className: i
                    }, a.createElement("div", {
                        "aria-hidden": !0,
                    ...
                    }), G.c.getString(r)), a.createElement("li", {
                        className: i
                    }, a.createElement("div", {
                        "aria-hidden": !0,
        ...
        const ks = "#38c2ee",
            Os = Object.assign({}, l.b, {
                neutralPalette: Object(cs.a)(Object(ns.c)(ks))
            });
        const xs = Object(o.b)(function (e) {
            return e
        })(Object(c.a)(w)(class extends D.a {
            constructor(e) {
                super(e), this.handledProps = {
                    ...
                    W.saveHighVisibilityMode(e), this.props.dispatch(Ue(Object.assign({}, Ye.getState(), {
                        highVisibilityMode: e
                    }))), Xe.data.session.settings.highVisibility = e, Qe.system.redrawAll()
                }, this.onReducedSpeedModeChange = () => {
                    const e = this.props.gameSpeed === We ? He : We;
                    W.saveReducedSpeedMode(e !== We), this.props.dispatch(Ue(Object.assign({}, Ye.getState(), {
                        gameSpeed: e
                    })))
                }, this.onGameModeChange = e => {
                    this.props.dispatch(Ue(Object.assign({}, Ye.getState(), {
                        mode: e
                    }))), Qe.system.changeGameState(Je.Menu), W.saveGameMode(e)
                }, this.onNewGameClick = () => {
                    Qe.system.changeGameState(Je.Menu)
                }, this.onHamburgerMenuClick = e => {
                    "function" == typeof this.props.onClick && this.props.onClick(e), this.state.menuOpen || this.props.gameState !== Je.Play || Qe.system.changeGameState(Je.Pause), this.setState({
                    ...
                    this.props.setModal(a.createElement(rs, {
                        onClick: Ss,
                    ...
                    this.props.setModal(a.createElement(B.a, {
                    ...
                    this.props.dispatch(Ve()), W.resetAllStats(), this.closeModal()
                }, this.state = {
                    menuOpen: !1
                }
            }
            render() {
                return a.createElement(a.Fragment, null, a.createElement(n.a, {
                    designSystem: Os
                }, a.createElement(f.a, {
                    value: ks,
                    tag: null,
                ...
                }), a.createElement(R.a, null)))), this.renderMenu())
            }
            getHighScore() {
                switch (this.props.mode) {
                    case b.Buoy:
                        return Math.max(this.props.buoy_bestScore, 0).toString();
                    case b.Speed:
                        return Ke(this.props.speed_bestScore);
                    case b.Classic:
                    default:
                        return Math.max(this.props.classic_bestScore, 0).toString()
                }
            }
            renderMenu() {
                ...
                return a.createElement(v.a, {
                    ...
                    width: "280px",
                    height: "fit-content",
                    defaultVerticalPosition: T.c.bottom,
                    defaultHorizontalPosition: T.b.left,
                    verticalPositioningMode: T.a.adjacent,
            ...
            renderToggleSection() {
                ...
                return a.createElement(a.Fragment, null, a.createElement("div", {
                    ...
                    selectedMessage: e,
                    unselectedMessage: s,
                    selected: this.props.gameSpeed !== We,
            ...
            renderButtonSection() {
                ...
                }, G.c.getString("howToPlayButton")), a.createElement(C.a, {
                    jssStyleSheet: y,
                    onClick: this.openGameCreditsModal
                }, G.c.getString("gameCreditsButton")), a.createElement(C.a, {
                    jssStyleSheet: y,
        ...
        window.addEventListener("beforeunload", () => {
            ...
            _ = new F("surfboard64", 13, 3), U = new F("player64", 13, 9), V = new F("enemy128", 2, 6), Y = new F("surfer64", 27, 2), z = new F("docks64", 10, 1), K = new F("objects64", 30, 1), J = new F("objects32", 20, 1), X = new F("interact64", 8, 4), q = new F("slowdown64", 9, 3), Q = new F("slowdown64", 3, 3), Z = new F("effects128", 6, 3), ee = new F("ripple96", 1, 3), se = new F("ambient64", 4, 6), te = new F("sandbar256", 4, 1), ie = new F("island1280", 1, 1), window.addEventListener("gamepadconnected", function (e) {
                    ...
                    navigator.getGamepads()[s], Be.system.controllerList.push(s)
                }), window.addEventListener("gamepaddisconnected", function (e) {
                    const s = Be.system,
                        t = e.gamepad.index,
                        i = s.controllerList.indexOf(t);
                    i > -1 && s.controllerList.splice(i, 1), Xe.data.controller = {
                        index: -1,
                        pad: -1,
                        pressed: {}
                    }
                ...
                function () {
                    window.addEventListener("keydown", function (e) {
                        Xe.data.changeInputMethod("keyboard"), t.onKeydown(e)
                    ...
                    const t = {
                        ...
                        onKeydown: function (i) {
                            if (!this.pressed[i.keyCode]) {
                                if (this.pressed[i.keyCode] = !0, "MENU" === Xe.data.session.state) {
                                    const t = i.keyCode;
                                    if (e && t === this.codes[s][this.codePosition + 1]) {
                                        if (this.codePosition++, t === this.codes[s][this.codes[s].length - 1]) {
                                            switch (s) {
                                                case 0:
                                                    Re.system.routeInputType("KONAMI");
                                                    break;
                                                case 1:
                                                    Re.system.routeInputType("MICROSOFT");
                                                    break;
                                                case 2:
                                                    Re.system.routeInputType("EDGE")
                                            }
                                ...
                                switch (i.keyCode) {
                                    case t.DOWN:
                                    case t.S:
                                        Re.system.routeInputType("DOWN");
                                        break;
                                    case t.UP:
                                    case t.W:
                                        Re.system.routeInputType("UP");
                                        break;
                                    case t.LEFT:
                                    case t.A:
                                        Re.system.routeInputType("LEFT");
                                        break;
                                    case t.RIGHT:
                                    case t.D:
                                        Re.system.routeInputType("RIGHT");
                                        break;
                                    case t.ENTER:
                                    case t.SPACE:
                                        Xe.data.session.isFlyoutActive || Re.system.routeInputType("FORWARD");
                                        break;
                                    case t.BACKSPACE:
                                    case t.DELETE:
                                        Xe.data.session.isFlyoutActive || Re.system.routeInputType("BACKWARD");
                                        break;
                                    case t.HOME:
                                    case t.ESC:
                                        Re.system.routeInputType("TOGGLE PLAY");
                                        break;
                                    case t.F:
                                        Re.system.routeInputType("BOOST")
                                }
                            }
                        },
                        onKeyup: function (e) {
                ...
                function () {
                    window.addEventListener("mousemove", function (s) {
                        "PLAY" === Xe.data.session.state && e.onMouseMove(s)
                    ...
                    const e = {
                        ...
                        definePosition: function (e) {
                            const s = Xe.data.session.xOrigin,
                                t = Xe.data.session.yOrigin,
                                i = e.clientX,
                                a = e.clientY,
                                o = 180 * Math.atan2(t - a, s - i) / Math.PI;
                            let r = this.moused;
                            return r = o < 0 && o > -55 ? "LEFT" : o > -180 && o < -125 ? "RIGHT" : o < -55 && o > -75 ? "DOWN LEFT" : o > -125 && o < -105 ? "DOWN RIGHT" : o > 0 && o < 180 ? "UP" : "DOWN", this.moused === r ? r : (Re.system.routeInputType(r), r)
                        },
                        onMouseClick: function (e) {
                            this.thisClick = Date.now(), this.thisClick - this.lastClick <= this.doubleDelta && ("PLAY" === Xe.data.session.state ? Re.system.routeInputType("BOOST") : Re.system.routeInputType("FORWARD"), this.thisClick = 0), this.lastClick = this.thisClick
                        }
                    }
                }(),
                function () {
                    window.addEventListener("touchstart", function (s) {
                        Xe.data.changeInputMethod("touch"), e.onTouchStart(s)
                    ...
                    const e = {
                        ...
                        onTouchMove: function (e) {
                            if (e.cancelable && e.preventDefault(), this.xMove = e.targetTouches[0].clientX, this.yMove = e.targetTouches[0].clientY, e.touches && !this.isInteractive(e) && "PLAY" === Xe.data.session.state) {
                        ...
                        onTouchEnd: function (e) {
                            ...
                            Math.abs(i) > 135 ? "MENU" === Xe.data.session.state ? Re.system.routeInputType("RIGHT") : Re.system.routeInputType("LEFT") : Math.abs(i) < 45 ? "MENU" === Xe.data.session.state ? Re.system.routeInputType("LEFT") : Re.system.routeInputType("RIGHT") : i > 45 && i < 135 && Re.system.routeInputType("DOWN"), this.isInteractive(e) || (this.thisTap = Date.now(), this.thisTap - this.lastTap <= this.doubleDelta && (Re.system.routeInputType("FORWARD"), this.thisTap = 0), this.lastTap = this.thisTap, this.touched = void 0, this.stopDefault(e))
                        },
                        ...
                        definePosition: function (e) {
                            const s = Xe.data.session.xOrigin,
                                ...
                                o = 180 * Math.atan2(t - a, s - i) / Math.PI;
                            let r = this.touched;
                            return r = o < 0 && o > -55 || i < .2 * Xe.data.session.width ? "LEFT" : o > -180 && o < -125 || i > .8 * Xe.data.session.width ? "RIGHT" : o < -55 && o > -75 ? "DOWN LEFT" : o > -125 && o < -105 ? "DOWN RIGHT" : o > 0 && o < 180 ? "UP" : "DOWN", this.touched === r ? r : (Re.system.routeInputType(r), r)
                        }
                    }
                }(),
                function () {
