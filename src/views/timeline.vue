...
import { ruby, link, timeline } from "@/assets/ts/partials";
        ...
        timeline([
            ...
            },
            {
                ...
                meta: [
                    ...
                    { date: "5 月 15 日", desc: "第一篇一作论文投稿（被拒，转投）" },
                    { date: "7 月", desc: "从紫金港校区搬到玉泉，正式成为玉泉黑色男孩.jpg" },
                    { date: "7 月 18 日", desc: "或许是一个新的开始？" },
                    { date: "10 月 10 日", desc: "赴深圳参加图灵大会" },
                    { date: "10 月", desc: "做了一个用一年时间超慢速播放《星际穿越》的相框" },
                    { date: "这一年", desc: "很贫瘠的一年" },
                ]
            },
        ]),
